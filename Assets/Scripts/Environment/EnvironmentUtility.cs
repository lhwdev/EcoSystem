...
public static class EnvironmentUtility {
    ...
    public static bool TileIsVisibile (Environment environment, int x, int y, int x2, int y2) {
    ...
    public static Coord[] GetPath (Environment environment, int x, int y, int x2, int y2) {
        // bresenham line algorithm
        int w = x2 - x;
        int h = y2 - y;
        int absW = System.Math.Abs (w);
